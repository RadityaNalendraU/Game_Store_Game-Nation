 ...
 * @author A C E R
 */
public class frm_edit_admin extends javax.swing.JFrame {
    koneksi dbsetting;
    ...
    private void btn_submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submitActionPerformed
        ...
        if((username.isEmpty()) | (email.isEmpty()) | (password.isEmpty())) {
            ...
            try {
                ...
                frm_data_admin game = new frm_data_admin();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_edit_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_edit_admin().setVisible(true);
            }
        });
    }
