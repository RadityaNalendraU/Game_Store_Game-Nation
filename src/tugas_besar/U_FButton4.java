...
public class U_FButton4 extends JButton {
    ...
    public U_FButton4() {
        fillOriginal = new Color(238,83,83);
        fillOver = new Color(238,83,83);
        fillClick = new Color(238,83,83);
        lineOriginal = new Color(238,83,83);
        lineOver = new Color(238,83,83);
