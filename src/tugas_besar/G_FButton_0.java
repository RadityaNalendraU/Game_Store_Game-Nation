 ...
 */
public class G_FButton_0  extends JButton {
    ...
    public G_FButton_0() {
        fillOriginal = new Color(80, 113, 229); 
        fillOver = new Color(80, 95, 229);
        fillClick = new Color(80, 90, 229);
        lineOriginal = new Color(80, 113, 229);
        lineOver = new Color(80, 113, 229);
